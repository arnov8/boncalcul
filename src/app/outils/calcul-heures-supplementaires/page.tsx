  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 mt-8">
        <AdBanner slot="heures-sup-top" format="horizontal" className="mb-6" />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <AdBanner slot="heures-sup-mid" format="auto" className="my-8" />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 pb-12">
        <AdBanner slot="heures-sup-bottom" format="horizontal" />
      </div>
    </>
  );
}
